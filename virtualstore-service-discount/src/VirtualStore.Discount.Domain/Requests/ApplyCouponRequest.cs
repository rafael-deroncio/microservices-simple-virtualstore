...
public class ApplyCouponRequest
{
    ...
    /// <summary>
    /// Gets or sets the total value of products for calculating the discount.
    /// </summary>
    [Range(0, double.MaxValue, ErrorMessage = "Total value of products must be non-negative.")]
